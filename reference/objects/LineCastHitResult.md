...
|Point|[Vector3](../md/objects/Vector3.md)|True|The point in world space where the linecast hit|
|Normal|[Vector3](../md/objects/Vector3.md)|True|The normal of the surface the linecast hit|
|Collider|[Collider](../md/objects/Collider.md)|True|The collider that was hit|
