...
|MountMapObject(mapObject : [MapObject](../objects/mapobject.md), positionOffset : [Vector3](../static/vector3.md), rotationOffset : [Vector3](../static/vector3.md))|none|Mounts the human on a map object|
|MountTransform(transform : [Transform](../objects/transform.md), positionOffset : [Vector3](../static/vector3.md), rotationOffset : [Vector3](../static/vector3.md))|none|Mounts the human on a transform|
