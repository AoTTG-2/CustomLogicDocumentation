...
### Methods
<pre class="language-typescript"><code class="lang-typescript">function OnValueChanged(valueChangedEvent: function) -> <a data-footnote-ref href="#user-content-fn-114">Slider</a></code></pre>
...
> 
<pre class="language-typescript"><code class="lang-typescript">function SetValueWithoutNotify(value: <a data-footnote-ref href="#user-content-fn-124">Object</a>)</code></pre>
