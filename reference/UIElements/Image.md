...
### Methods
<pre class="language-typescript"><code class="lang-typescript">function SetImage(imagePath: string) -> <a data-footnote-ref href="#user-content-fn-110">Image</a></code></pre>
