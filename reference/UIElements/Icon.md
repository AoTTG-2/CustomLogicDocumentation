...
### Methods
<pre class="language-typescript"><code class="lang-typescript">function SetIcon(iconPath: string) -> <a data-footnote-ref href="#user-content-fn-109">Icon</a></code></pre>
> Set the icon to display from a resource path.
> 
> **Parameters**:
> - `iconPath`: Path to the icon resource (e.g., "Icons/Game/BladeIcon").
> 
<pre class="language-typescript"><code class="lang-typescript">function SetTintColor(color: <a data-footnote-ref href="#user-content-fn-0">Color</a>) -> <a data-footnote-ref href="#user-content-fn-109">Icon</a></code></pre>
