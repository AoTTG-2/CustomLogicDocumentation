...
### Methods
<pre class="language-typescript"><code class="lang-typescript">function OnClick(clickEvent: function) -> <a data-footnote-ref href="#user-content-fn-105">Button</a></code></pre>
