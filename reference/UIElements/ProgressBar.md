...
### Methods
<pre class="language-typescript"><code class="lang-typescript">function OnValueChanged(valueChangedEvent: function) -> <a data-footnote-ref href="#user-content-fn-110">ProgressBar</a></code></pre>
...
> 
<pre class="language-typescript"><code class="lang-typescript">function SetPercentage(percentage: float) -> <a data-footnote-ref href="#user-content-fn-110">ProgressBar</a></code></pre>
