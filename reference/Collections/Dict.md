...
> 
<pre class="language-typescript"><code class="lang-typescript">function Get(key: <a data-footnote-ref href="#user-content-fn-124">Object</a>, defaultValue: <a data-footnote-ref href="#user-content-fn-124">Object</a> = null) -> <a data-footnote-ref href="#user-content-fn-124">Object</a><V></code></pre>
...
<pre class="language-typescript"><code class="lang-typescript">function Set(key: <a data-footnote-ref href="#user-content-fn-124">Object</a>, value: <a data-footnote-ref href="#user-content-fn-124">Object</a>)</code></pre>
...
> 
<pre class="language-typescript"><code class="lang-typescript">function Remove(key: <a data-footnote-ref href="#user-content-fn-124">Object</a>)</code></pre>
> Removes a value from the dictionary.
> 
> **Parameters**:
> - `key`: The key of the value to remove.
> 
<pre class="language-typescript"><code class="lang-typescript">function Contains(key: <a data-footnote-ref href="#user-content-fn-124">Object</a>) -> bool</code></pre>
