...
> - `z`: The Z component.
> 
<pre class="language-typescript"><code class="lang-typescript">function Scale(scale: <a data-footnote-ref href="#user-content-fn-124">Object</a>) -> <a data-footnote-ref href="#user-content-fn-8">Vector3</a></code></pre>
