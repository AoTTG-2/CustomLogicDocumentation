...
|RunAbnormal|string|True|Run abnormal animation.|
|SprintAbnormal|string|True|Sprint abnormal animation.|
|RunCrawler|string|True|Run crawler animation.|
|IdleCrawler|string|True|Idle crawler animation.|
|JumpCrawler|string|True|Jump crawler animation.|
|FallCrawler|string|True|Fall crawler animation.|
|LandCrawler|string|True|Land crawler animation.|
...
|StunLeft|string|True|Stun left animation.|
|StunRight|string|True|Stun right animation.|
|DieBack|string|True|Die back animation.|
|DieFront|string|True|Die front animation.|
|DieGround|string|True|Die ground animation.|
|DieCrawler|string|True|Die crawler animation.|
|DieSit|string|True|Die sit animation.|
|AttackPunchCombo|string|True|Attack punch combo animation.|
|AttackPunch|string|True|Attack punch animation.|
|AttackSlam|string|True|Attack slam animation.|
|AttackBellyFlop|string|True|Attack belly flop animation.|
|AttackBellyFlopGetup|string|True|Attack belly flop getup animation.|
|AttackKick|string|True|Attack kick animation.|
|AttackStomp|string|True|Attack stomp animation.|
|AttackSwingL|string|True|Attack swing left animation.|
|AttackSwingR|string|True|Attack swing right animation.|
|AttackBiteF|string|True|Attack bite front animation.|
|AttackBiteL|string|True|Attack bite left animation.|
|AttackBiteR|string|True|Attack bite right animation.|
|AttackGrabAirFarL|string|True|Attack grab air far left animation.|
|AttackGrabAirFarR|string|True|Attack grab air far right animation.|
|AttackGrabAirL|string|True|Attack grab air left animation.|
|AttackGrabAirR|string|True|Attack grab air right animation.|
|AttackGrabBackL|string|True|Attack grab back left animation.|
|AttackGrabBackR|string|True|Attack grab back right animation.|
|AttackGrabCoreL|string|True|Attack grab core left animation.|
|AttackGrabCoreR|string|True|Attack grab core right animation.|
|AttackGrabGroundBackL|string|True|Attack grab ground back left animation.|
|AttackGrabGroundBackR|string|True|Attack grab ground back right animation.|
|AttackGrabGroundFrontL|string|True|Attack grab ground front left animation.|
|AttackGrabGroundFrontR|string|True|Attack grab ground front right animation.|
|AttackGrabHeadBackL|string|True|Attack grab head back left animation.|
|AttackGrabHeadBackR|string|True|Attack grab head back right animation.|
|AttackGrabHeadFrontL|string|True|Attack grab head front left animation.|
|AttackGrabHeadFrontR|string|True|Attack grab head front right animation.|
|AttackGrabHighL|string|True|Attack grab high left animation.|
|AttackGrabHighR|string|True|Attack grab high right animation.|
|AttackGrabStomachL|string|True|Attack grab stomach left animation.|
|AttackGrabStomachR|string|True|Attack grab stomach right animation.|
|AttackEatL|string|True|Attack eat left animation.|
|AttackEatR|string|True|Attack eat right animation.|
|AttackSlapHighL|string|True|Attack slap high left animation.|
|AttackSlapHighR|string|True|Attack slap high right animation.|
|AttackSlapL|string|True|Attack slap left animation.|
|AttackSlapR|string|True|Attack slap right animation.|
|AttackSlapLowL|string|True|Attack slap low left animation.|
|AttackSlapLowR|string|True|Attack slap low right animation.|
|AttackBrushChestL|string|True|Attack brush chest left animation.|
|AttackBrushChestR|string|True|Attack brush chest right animation.|
|AttackHitBack|string|True|Attack hit back animation.|
|AttackHitFace|string|True|Attack hit face animation.|
|AttackRockThrow|string|True|Attack rock throw animation.|
|AttackJump|string|True|Attack jump animation.|
|AttackJumpCrawler|string|True|Attack jump crawler animation.|
|SitIdle|string|True|Sit idle animation.|
|SitIdleCrawler|string|True|Sit idle crawler animation.|
|SitDown|string|True|Sit down animation.|
|SitUp|string|True|Sit up animation.|
|SitUpCrawler|string|True|Sit up crawler animation.|
|SitFall|string|True|Sit fall animation.|
|SitFallCrawler|string|True|Sit fall crawler animation.|
|Turn90L|string|True|Turn 90 left animation.|
|Turn90R|string|True|Turn 90 right animation.|
|Turn90LCrawler|string|True|Turn 90 left crawler animation.|
|Turn90RCrawler|string|True|Turn 90 right crawler animation.|
|Blind|string|True|Blind animation.|
|SitBlind|string|True|Sit blind animation.|
|BlindCrawler|string|True|Blind crawler animation.|
|ArmHurtL|string|True|Arm hurt left animation.|
|ArmHurtR|string|True|Arm hurt right animation.|
|CoverNape|string|True|Cover nape animation.|
|EmoteLaugh|string|True|Emote laugh animation.|
|EmoteNod|string|True|Emote nod animation.|
|EmoteShake|string|True|Emote shake animation.|
