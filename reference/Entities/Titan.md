...
|State|string|True|State of the titan.|
...
> 
<pre class="language-typescript"><code class="lang-typescript">function GetTarget() -> <a data-footnote-ref href="#user-content-fn-124">Object</a></code></pre>
