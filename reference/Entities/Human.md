...
> 
<pre class="language-typescript"><code class="lang-typescript">function MoveToTarget(target: <a data-footnote-ref href="#user-content-fn-124">Object</a>, range: float)</code></pre>
