...
> 
<pre class="language-typescript"><code class="lang-typescript">function SweepTest(direction: <a data-footnote-ref href="#user-content-fn-8">Vector3</a>, distance: float) -> <a data-footnote-ref href="#user-content-fn-122">Object</a></code></pre>
